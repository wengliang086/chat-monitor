...
demo_build_dir=/root/fastaccess/build/fast_access_sdk_dir
sdk_deploy_dir=/root/access/fastaccess_web/download/demo
demo_name=hoolai_sdk_cocos_demo
...
deploy(){
	...
	svn co http://svn.hoolai.com/access-platform/trunk/access_sdk/cplusplus/HoolaiSDKDemo -r head $demo_build_dir/$1
	check "$1更新成功"
