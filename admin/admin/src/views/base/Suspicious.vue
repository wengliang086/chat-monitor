...
<section>
    ...
    <el-table :data="suspiciousData" highlight-current-row v-loading="listLoading" style="width: 100%;">

        <!--<el-table-column type="selection" width="55"></el-table-column>		    <el-table-column type="index" width="60"></el-table-column>-->
    ...
    <!--编辑界面-->
    <el-dialog title="审核" :visible="editFormVisible" :close-on-click-modal="false">
...
export default {
    data() {
        return {
            ...
            gameList: null,
            /**[{gameId: '1000',gameName: '焚天'}, {gameId: '1001',gameName: '勇者大作战'}}]*/
            value8: '',
            //owIndex: '-1',
            //OrderIndexArr: [],
            //hoverOrderArr: []
