...
<section>
	...
	<el-col class="toolbar" style="padding-bottom: 0px;">
		<el-form :inline="true" :model="filters">
			...
			<el-form-item>
				<el-button type="primary" @click="showAddUserDialog" icon="el-icon-plus">新增</el-button>
			</el-form-item>
		</el-form>
	</el-col>
	...
	<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
		...
		<el-table-column label="操作" width="180">
			<template slot-scope="scope">
				<el-button size="small" @click="showEditUserDialog(scope.$index, scope.row)" icon="el-icon-edit">编辑</el-button>
	...
	<!--新增界面-->
	<el-dialog title="新增用户" :visible="addFormVisible" :close-on-click-modal="false">
